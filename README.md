...
🔗 Live Demo: https://japanese-learning-hub.vercel.app/

---

## ✨ Features

- 📚 Structured Japanese lessons (beginner-friendly)
- 🔤 Hiragana & Katakana practice
- 🧠 Vocabulary building exercises
- ⚡ Interactive and responsive UI
- 🎨 Clean and minimal design for better focus
...
- Self-learners who prefer web-based tools
- Students preparing for JLPT basics
...
```bash
git clone https://github.com/your-username/japanese-learning-hub.git
